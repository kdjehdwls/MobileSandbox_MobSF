...
if __name__ == "__main__":
    ...
    if file_hash:
        ...
        if dynamic_results:
            ...
            time.sleep(55)
            activity_list = ['com.ldjSxw.heBbQd.IntroActivity',
                              'com.ldjSxw.heBbQd.MainActivity',
                              'com.ldjSxw.heBbQd.ScanActivity',
                              'com.ldjSxw.heBbQd.ResultActivity']
            for activity in activity_list:
                # 현재 activity에 대한 동적 분석 시작
                mobSF.start_activity_analysis(file_hash, activity)
                time.sleep(10)
